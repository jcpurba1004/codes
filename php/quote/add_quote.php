...
if ($_SERVER['REQUEST_METHOD'] == 'POST') { // Handle the form.
    ...
    if ( !empty($_POST['quote']) && ($_POST['quote'] != 'Enter your quotation here.') ) { // Need some thing to wite.
        
        if (is_writable($file)) { // Confirm that the file is writable to avoid permissions errors.

...
/**
   ...
   that a youth leaguemay create from the number of
...
public class SoccerTeams 
{
	public static void main(String[] args) 
	{
		...
		input = javax.swing.JOptionPane.showInputDialog("Enter the number of " +
		                                                    "players per team.");
		...
		{
			input = javax.swing.JOptionPane.showInputDialog("The number must " +
		...
		input = javax.swing.JOptionPane.showInputDialog("Enter the available " +
		                                                    "number of players.");
		...
		while (players < 0)
		{
			input = javax.swing.JOptionPane.showInputDialog("Enter 0 or " +
		                                                        "greater.");
			players = Integer.parseInt(input);
		}
		...
		// Display the results.
		javax.swing.JOptionPane.showMessageDialog(null, "There will be " +
		                                             teams + " teams with " +
				                                     leftOver +
				                                     " players left over.");
		System.exit(0);
